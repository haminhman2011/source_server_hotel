...
?>
<form id="form_number_of_beds_search" class="search-form">
	<div class="row">
...
<script>
    $(function() {
        let body = $("body");
        // PHẦN TÌM KIẾM
        $("#form_number_of_beds_search").on('submit', function () {
        ...
        body.on('click', '#btn_reset_filter', function () {
            $("#form_number_of_beds_search").find('input, select').val('').trigger('change');
